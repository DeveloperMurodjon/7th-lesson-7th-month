...
function ProductCard({ product }) {
    ...
    return (
        <div className="max-w-[300px] border-2 rounded-2xl overflow-hidden shadow-md">
            ...
            <div className="p-3">
                ...
                <p className="font-medium my-4  text-sm text-gray-700 line-clamp-4">{product.description}</p>
